...
abstract class BaseCmsCategoryPeer
{
    ...
    const OM_CLASS = 'CmsCategory';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CmsCategoryTableMap';
    ...
    const CAT_ID = 'cms_category.cat_id';

    /** the column name for the cat_name field */
    const CAT_NAME = 'cms_category.cat_name';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('CatId', 'CatName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('catId', 'catName', ),
        BasePeer::TYPE_COLNAME => array (CmsCategoryPeer::CAT_ID, CmsCategoryPeer::CAT_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CAT_ID', 'CAT_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('cat_id', 'cat_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('CatId' => 0, 'CatName' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('catId' => 0, 'catName' => 1, ),
        BasePeer::TYPE_COLNAME => array (CmsCategoryPeer::CAT_ID => 0, CmsCategoryPeer::CAT_NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CAT_ID' => 0, 'CAT_NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('cat_id' => 0, 'cat_name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CmsCategoryPeer::CAT_ID);
            $criteria->addSelectColumn(CmsCategoryPeer::CAT_NAME);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCmsCategoryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \CmsCategoryTableMap());
      }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CmsCategoryPeer::CAT_ID) && $criteria->keyContainsValue(CmsCategoryPeer::CAT_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.CmsCategoryPeer::CAT_ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CmsCategoryPeer::CAT_ID);
            $value = $criteria->remove(CmsCategoryPeer::CAT_ID);
            if ($value) {
                $selectCriteria->add(CmsCategoryPeer::CAT_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CmsCategoryPeer::CAT_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(CmsCategoryPeer::DATABASE_NAME);
        $criteria->add(CmsCategoryPeer::CAT_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CmsCategoryPeer::DATABASE_NAME);
            $criteria->add(CmsCategoryPeer::CAT_ID, $pks, Criteria::IN);
