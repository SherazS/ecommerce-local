...
abstract class BaseCmsCategory extends BaseObject implements Persistent
{
    ...
    public function setCatId($v)
    {
        ...
        if ($this->cat_id !== $v) {
            $this->cat_id = $v;
            $this->modifiedColumns[] = CmsCategoryPeer::CAT_ID;
        }
    ...
    public function setCatName($v)
    {
        ...
        if ($this->cat_name !== $v) {
            $this->cat_name = $v;
            $this->modifiedColumns[] = CmsCategoryPeer::CAT_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = CmsCategoryPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CmsCategoryPeer::CAT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`cat_id`';
        }
        if ($this->isColumnModified(CmsCategoryPeer::CAT_NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CmsCategoryPeer::doValidate($this, $columns)) !== true) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CmsCategoryPeer::CAT_ID)) $criteria->add(CmsCategoryPeer::CAT_ID, $this->cat_id);
        if ($this->isColumnModified(CmsCategoryPeer::CAT_NAME)) $criteria->add(CmsCategoryPeer::CAT_NAME, $this->cat_name);
    ...
    {
        $criteria = new Criteria(CmsCategoryPeer::DATABASE_NAME);
        $criteria->add(CmsCategoryPeer::CAT_ID, $this->cat_id);
    ...
    public function setCmsArticles(PropelCollection $cmsArticles, PropelPDO $con = null)
    {
        ...
        foreach ($cmsArticlesToDelete as $cmsArticleRemoved) {
            $cmsArticleRemoved->setCmsCategory(null);
        }
    ...
    protected function doAddCmsArticle($cmsArticle)
    {
        ...
        $cmsArticle->setCmsCategory($this);
    }
    ...
    public function removeCmsArticle($cmsArticle)
    {
        if ($this->getCmsArticles()->contains($cmsArticle)) {
            ...
            $cmsArticle->setCmsCategory(null);
        }
     ...
     * Otherwise if this CmsCategory is new, it will return
     * an empty collection; or if this CmsCategory has previously
     * been saved, it will retrieve related CmsArticles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CmsCategory.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|CmsArticle[] List of CmsArticle objects
     */
    public function getCmsArticlesJoinUserMain($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CmsArticleQuery::create(null, $criteria);
        $query->joinWith('UserMain', $join_behavior);
