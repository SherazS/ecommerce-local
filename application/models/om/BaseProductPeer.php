...
abstract class BaseProductPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ProductId', 'ProductCategoryId', 'ProductName', 'ProductImage', 'ProductDescription', 'ProductPrice', 'ProductQuantity', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('productId', 'productCategoryId', 'productName', 'productImage', 'productDescription', 'productPrice', 'productQuantity', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::PRODUCT_ID, ProductPeer::PRODUCT_CATEGORY_ID, ProductPeer::PRODUCT_NAME, ProductPeer::PRODUCT_IMAGE, ProductPeer::PRODUCT_DESCRIPTION, ProductPeer::PRODUCT_PRICE, ProductPeer::PRODUCT_QUANTITY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PRODUCT_ID', 'PRODUCT_CATEGORY_ID', 'PRODUCT_NAME', 'PRODUCT_IMAGE', 'PRODUCT_DESCRIPTION', 'PRODUCT_PRICE', 'PRODUCT_QUANTITY', ),
        BasePeer::TYPE_FIELDNAME => array ('product_id', 'product_category_id', 'product_name', 'product_image', 'product_description', 'product_price', 'product_quantity', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ProductId' => 0, 'ProductCategoryId' => 1, 'ProductName' => 2, 'ProductImage' => 3, 'ProductDescription' => 4, 'ProductPrice' => 5, 'ProductQuantity' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('productId' => 0, 'productCategoryId' => 1, 'productName' => 2, 'productImage' => 3, 'productDescription' => 4, 'productPrice' => 5, 'productQuantity' => 6, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::PRODUCT_ID => 0, ProductPeer::PRODUCT_CATEGORY_ID => 1, ProductPeer::PRODUCT_NAME => 2, ProductPeer::PRODUCT_IMAGE => 3, ProductPeer::PRODUCT_DESCRIPTION => 4, ProductPeer::PRODUCT_PRICE => 5, ProductPeer::PRODUCT_QUANTITY => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PRODUCT_ID' => 0, 'PRODUCT_CATEGORY_ID' => 1, 'PRODUCT_NAME' => 2, 'PRODUCT_IMAGE' => 3, 'PRODUCT_DESCRIPTION' => 4, 'PRODUCT_PRICE' => 5, 'PRODUCT_QUANTITY' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('product_id' => 0, 'product_category_id' => 1, 'product_name' => 2, 'product_image' => 3, 'product_description' => 4, 'product_price' => 5, 'product_quantity' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function doCountJoinCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ProductPeer::PRODUCT_CATEGORY_ID, CategoryPeer::CATEGORY_ID, $join_behavior);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ProductPeer::PRODUCT_ID) && $criteria->keyContainsValue(ProductPeer::PRODUCT_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ProductPeer::PRODUCT_ID);
            $value = $criteria->remove(ProductPeer::PRODUCT_ID);
            if ($value) {
                $selectCriteria->add(ProductPeer::PRODUCT_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ProductPeer::PRODUCT_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ProductPeer::DATABASE_NAME);
        $criteria->add(ProductPeer::PRODUCT_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ProductPeer::DATABASE_NAME);
            $criteria->add(ProductPeer::PRODUCT_ID, $pks, Criteria::IN);
