...
abstract class BaseCategoryPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('CategoryId', 'CategoryName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('categoryId', 'categoryName', ),
        BasePeer::TYPE_COLNAME => array (CategoryPeer::CATEGORY_ID, CategoryPeer::CATEGORY_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CATEGORY_ID', 'CATEGORY_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('category_id', 'category_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('CategoryId' => 0, 'CategoryName' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('categoryId' => 0, 'categoryName' => 1, ),
        BasePeer::TYPE_COLNAME => array (CategoryPeer::CATEGORY_ID => 0, CategoryPeer::CATEGORY_NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CATEGORY_ID' => 0, 'CATEGORY_NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('category_id' => 0, 'category_name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(CategoryPeer::CATEGORY_ID);
            if ($value) {
                $selectCriteria->add(CategoryPeer::CATEGORY_ID, $value, $comparison);
            } else {
