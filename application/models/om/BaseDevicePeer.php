...
abstract class BaseDevicePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('DeviceId', 'DeviceName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('deviceId', 'deviceName', ),
        BasePeer::TYPE_COLNAME => array (DevicePeer::DEVICE_ID, DevicePeer::DEVICE_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('DEVICE_ID', 'DEVICE_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('device_id', 'device_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('DeviceId' => 0, 'DeviceName' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('deviceId' => 0, 'deviceName' => 1, ),
        BasePeer::TYPE_COLNAME => array (DevicePeer::DEVICE_ID => 0, DevicePeer::DEVICE_NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('DEVICE_ID' => 0, 'DEVICE_NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('device_id' => 0, 'device_name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(DevicePeer::DEVICE_ID);
            $criteria->addSelectColumn(DevicePeer::DEVICE_NAME);
        } else {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(DevicePeer::DEVICE_ID) && $criteria->keyContainsValue(DevicePeer::DEVICE_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(DevicePeer::DEVICE_ID);
            $value = $criteria->remove(DevicePeer::DEVICE_ID);
            if ($value) {
                $selectCriteria->add(DevicePeer::DEVICE_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(DevicePeer::DEVICE_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(DevicePeer::DATABASE_NAME);
        $criteria->add(DevicePeer::DEVICE_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(DevicePeer::DATABASE_NAME);
            $criteria->add(DevicePeer::DEVICE_ID, $pks, Criteria::IN);
