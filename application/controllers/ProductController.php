...
class ProductController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $productArray = array();
        if($selectProduct) {
            $productArray['product-page-name' ] = '<div id="product-page-name">' . $selectProduct->getProductName() . '</div>';
            $productArray['product-page-image'] = '<div id="product-page-image"><img src="/images/' . $selectProduct->getProductImage() . '" /></div>';
